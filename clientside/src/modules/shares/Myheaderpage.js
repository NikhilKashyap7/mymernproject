...
import { logout } from '../reduxpage/Myaction';
      ...
      <div className="container-fluid ">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li>
              {vusername ? (
                <button onClick={handleLogout} className='nav-link active me-2 underline'><LogoutIcon/>Logout</button>
              ) : (
                <Link to='/myloginpage' className="nav-link active me-2 underline "><LoginIcon/>Login</Link>
              )}
            </li>
